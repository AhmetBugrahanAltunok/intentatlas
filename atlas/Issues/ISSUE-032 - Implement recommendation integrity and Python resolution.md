...
## 17A - reproduction and frozen contract

- [x] Verify clean synchronized Phase 16 entry at `174369afc56d603373de1443d7826c92fcec395a`.
- [x] Reproduce Click `00e592cea702e0b2caa0dee42489fdb1c22cd845` and self-scan findings without
      executing third-party code.
- [x] Freeze the unchanged longitudinal baseline twice and add seven red regressions before fixes.
...
- decided-by:: [[Decisions/ADR-033 - Canonicalize confidence and conservative Python resolution]]
