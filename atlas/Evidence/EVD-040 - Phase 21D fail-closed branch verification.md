...
Local decision: **verified, 2026-09-11**. Complete suite: **637 passed, 4 skipped**, exit **0**,
branch-enabled total coverage **87.60%**, duration **166.73s**. Ruff, mypy (50 source files) and
...
| Project total | 86.47% | 87.60% |

Suite size moved from 612 to 637 collected passes; the 25 additions are the regressions listed
...
- `acquisition.py` at 76% and `longitudinal.py` at 75% were not addressed here.
